        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <a v-if="course.price==0||isBuy" :href="'/player/'+chapterList[0].children[0].videoSourceId"
                 title="立即观看"
                 class="comm-btn c-btn-3">立即观看</a>
              <a v-else @click="createOrder" title="立即购买" class="comm-btn c-btn-3">立即购买</a>
            </section>
          </section>
        </aside>
  ...
  methods: {
    initCourseInfo() {
      ...
      course.getById(this.courseId).then(res => {
        ...
        this.chapterList = res.data.data.chapterVoList
